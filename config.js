const config = {
  ...
  "settings": {
    ...
    "facebookPixelId": "1312017696453752",
    "salesGeniusAppApi": "",
    "followUpBossEmail": "",
  ...
  "prize": {
    "images": [
      {
        "src": "https://iili.io/KGqmKB4.webp",
      ...
      {
        "src": "https://iili.io/KGqm9kX.webp",
  ...
  "rules": {
    "faq": [
      ...
      },
      {
        ...
        "a": "We’ll email the winner on October 16th. Be sure to check your inbox (and spam) so you don’t miss it."
      },
      {
    ...
    "tips": [
      ...
      "Follow @the.real.janelle on Instagram & Facebook.",
      "Double-check your phone number – A quick call could be the best one you ever get."
    ],
    "finePrintText": "",
